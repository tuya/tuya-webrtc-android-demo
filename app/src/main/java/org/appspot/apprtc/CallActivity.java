...
public class CallActivity extends Activity implements AppRTCClient.SignalingEvents,
	...
	public final String clientId = clientId_;
	public final String secret  = cecret_;
	public final String deviceid = deviceid_;
	public final String localKey = localKey_;
	public final String authCode = authCode_;
	public boolean _bIPCDebug ;


	public static final String EXTRA_IPCDEBUG = "org.appspot.apprtc.IPCDEBUG";		// for ipc debug
...
//		QueryHwCodecCapability();
		...
		Boolean ipcDebug = intent.getBooleanExtra(EXTRA_IPCDEBUG,false);			// for ipc test
		_bIPCDebug = ipcDebug ;
		...
		if (ipcDebug)
		{
			appRtcClient = new MqttRTCClient(this) ;
		}else
		{
		...
		if (ipcDebug){
			...
			roomConnectionParameters = new RoomConnectionParameters(roomUri.toString(), roomId, loopback, urlParameters,clientId,secret,deviceid,localKey,authCode);
		}else
		{
			String urlParameters = intent.getStringExtra(EXTRA_URLPARAMETERS);
	...
	private void onConnectedToRoomInternal(final SignalingParameters params) {
		...
		if (_bIPCDebug)
		{
			...
			if (signalingParameters.initiator == false) {
				...
				signalingParameters.initiator = true ;
			}
		}else
		{
			VideoCapturer videoCapturer = null;
